 ...
 primesr: {
    ...
    'yespowerTIDE': {
        ...
        hash: function (coinConfig) {
            ...
            var rValue = coinConfig.rValue || 32;
            return function (data) {
                return multiHashing.yespower_tide(data, nValue, rValue);
            }
        }
    },
    'TIDE': {
        ...
        hash: function (coinConfig) {
            ...
            var rValue = coinConfig.rValue || 32;
            return function (data) {
                return multiHashing.yespower_tide.apply(data, nValue, rValue);
            }
        }
    },
    'yespowerLTNCG': {
...
*/
    cpupower: {
        ...
        hash: function () {
            return function () {
                return multiHashing.cpupower.apply(this, arguments);
            }
        }
    },
